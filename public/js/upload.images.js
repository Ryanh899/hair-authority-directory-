...
$(document).ready(function () {
    ...
    $(document).on('click', '#add-pet-upload-feature', function () {
        $(`input[id='add-pet-upload-image-feature']`).trigger('click');
        document.getElementById('add-pet-upload-image-feature').addEventListener('change', readFeatureFile);
    });
