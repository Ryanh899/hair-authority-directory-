...
//         $(`input[id='img-upload-image']`).trigger('click');
//         document.getElementById('img-upload-image').addEventListener('change', readFile);
//     });

//     $(document).on('click', '#img-upload-feature', function () {
//         $(`input[id='img-upload-image-feature']`).trigger('click');
//         document.getElementById('img-upload-image-feature').addEventListener('change', readFeatureFile);
//     });
...
//             // pass base64 image to be uploaded to jumbotron
//             displayFeaturePhoto(base64Img.target.result);
//             images.push(base64Img.target.result);
//             console.log(`images: ${images}`);
...
// function displayFeaturePhoto(image) {
//     // $('.add-pet-camera').empty();
//     $('#feature-append').append(`<img src="${image}" alt="image" class="ui small image">`);
//     retakePhoto();
// };
